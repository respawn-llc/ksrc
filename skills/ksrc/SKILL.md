...
- Gradle files with unresolved class version: User's Local java in env is resolved to something unsuppported by gradle. Help them fix Gradle<>JDK incompatibility.
